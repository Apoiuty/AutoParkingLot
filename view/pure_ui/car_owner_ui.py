...
class Ui_Car_owner(object):
    ...
    def retranslateUi(self, Car_owner):
        ...
        Car_owner.setWindowTitle(_translate("Car_owner", "Dialog"))
        self.label_name.setText(_translate("Car_owner", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt;\">姓名：</span></p></body></html>"))
        self.label_pos.setText(_translate("Car_owner", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt;\">车位：</span></p></body></html>"))
        ...
        self.label_plate.setText(_translate("Car_owner", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt;\">车牌号：</span></p></body></html>"))
...
if __name__ == "__main__":
    ...
    Car_owner = QtWidgets.QDialog()
    ui = Ui_Car_owner()
    ui.setupUi(Car_owner)
    Car_owner.show()
    sys.exit(app.exec_())
