...
class Ui_LogByCarName(object):
    def setupUi(self, LogByCarName):
        ...
        self.line = QtWidgets.QFrame(LogByCarName)
        ...
        self.CarNameInputPro = QtWidgets.QLabel(LogByCarName)
        font = QtGui.QFont()
        font.setFamily("等线")
        ...
        self.CarNameInput = QtWidgets.QLineEdit(LogByCarName)
        ...
        self.CarNameConfirm = QtWidgets.QPushButton(LogByCarName)
        font = QtGui.QFont()
        font.setFamily("Consolas")
        font.setPointSize(18)
        ...
        self.line_2 = QtWidgets.QFrame(LogByCarName)
        self.line_2.setLineWidth(2)
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.verticalLayout.addWidget(self.line_2)
        self.TableOfCarLog = QtWidgets.QTableView(LogByCarName)
    ...
    def retranslateUi(self, LogByCarName):
        ...
        self.label.setText(_translate("LogByCarName", "<html><head/><body><p align=\"center\"><span style=\" font-size:18pt; font-weight:600; color:#55aaff;\">车辆进出查询</span></p></body></html>"))
        self.CarNameInputPro.setText(_translate("LogByCarName", "<html><head/><body><p><span style=\" font-size:18pt; font-weight:600;\">请输入车牌号：</span></p></body></html>"))
